...
void Game::DoEvents()
{
    ...
    while (wnd->pollEvent(evt))
    {
        ...
        if (Keyboard::isKeyPressed(Keyboard::Up))
            controlBodyAvatar->AplicarFuerza(b2Vec2(0, -velocidad), b2Vec2(controlBody->GetWorldCenter()));
...
void Game::InitPhysics()
{
    ...
    controlBody = Box2DHelper::CreateRectangularDynamicBody(phyWorld, 5, 6, 5,1,0);
